			...
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<div class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="<?= base_url('laporan_ful/laba') ?>">Laba Rugi</a></li>
							<li><a class="dropdown-item" href="<?= base_url('laporan_ful/jurnal') ?>">Jurnal Umum</a></li>
							<li><a class="dropdown-item" href="<?= base_url('laporan_ful/buku') ?>">Buku Besar</a></li>
							<li><a class="dropdown-item" href="<?= base_url('laporan_ful/neraca') ?>">Neraca</a></li>
							<li><a class="dropdown-item" href="<?= base_url('laporan_ful/saldo') ?>">Neraca Saldo</a></li>
							<li><a class="dropdown-item" href="<?= base_url('laporan_ful/kas') ?>">Arus Kas</a></li>
							<li><a class="dropdown-item" href="<?= base_url('laporan_ful/shu') ?>">SHU</a></li>
						</ul>
					</div>
				</li>
				<li class="nav-item">
