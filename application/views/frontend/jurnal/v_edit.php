				...
				<div class="card-body px-0 pb-2">
					<div class="table-responsive p-0">
						<table class="table align-items-center mb-0">
							<tbody>
								<?php
								echo form_open('jurnal/update/' . $jurnal->id_transaksi)
								?>
								...
								<div class="modal-body">
									...
									<div class="input-group input-group-outline mb-3">
										<input type="date" name="tgl_transaksi" class="form-control" value="<?= $jurnal->tgl_transaksi ?>" placeholder="tanggal transaksi">
									</div>
									<label class="form-label">Nama Akun</label>
									<div class="input-group input-group-outline mb-3">
										<select name="no_reff" id="reff" class="form-control">
											<option value="<?= $jurnal->no_reff ?>"><?= $jurnal->nama_reff ?></option>
											<option>--Pilih--</option>
									...
									<div class="input-group input-group-outline mb-3">
										<input type="text" name="no_reff" value="<?= $jurnal->no_reff ?>" class="no_reff form-control" disabled>
									</div>
									<label class="form-label">Jenis Saldo</label>
									<div class="input-group input-group-outline mb-3">
										<select name="jenis_saldo" class="form-control" id="">
											<option value="<?= $jurnal->jenis_saldo ?>"><?= $jurnal->jenis_saldo ?></option>
