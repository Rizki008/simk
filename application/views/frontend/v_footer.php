		...
		<div class="row align-items-center justify-content-lg-between">
			<div class="col-lg-6 mb-lg-0 mb-4">
				<div class="copyright text-center text-sm text-muted text-lg-start">
					...
					<a href="#" class="font-weight-bold" target="_blank">Sistem Informasi Managamen Keuangan</a>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	$("#reff").on('change', function() {
		...
		$(".no_reff").html($(this).find(':selected').attr('data-reff'));
		$(".no_reff").val($(this).find(':selected').attr('data-reff'));
	});
</script>
</body>
