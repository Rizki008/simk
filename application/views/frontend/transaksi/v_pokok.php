<div class="container-fluid py-4">
			...
			<div class="card my-4">
				<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
					<div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
						...
						<a href="<?= base_url('simpanan/add_pokok') ?>" class="btn bg-gradient-success btn-sm">
								...
								foreach ($pokok as $key => $value) { ?>
									<tr>
										...
										<td class="align-middle">
											<a href="<?= base_url('simpanan/update_pokok/' . $value->id_transaksi) ?>" class="btn bg-gradient-warning btn-sm">
												Edit
											</a>
	...
	<?php foreach ($pokok as $key => $valuesa) { ?>
		<div class="modal fade" id="delete<?= $valuesa->id_transaksi ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<?php
					echo form_open('anggota/delete/' . $valuesa->id_transaksi)
					?>
