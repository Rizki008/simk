		...
		<div class="col-12">
            ...
            <h5><i class="icon fa fa-exclamation-triangle"></i>', '</h5></div>');
                ...
                <h5><i class="icon fa fa-exclamation-triangle"></i>' . $error_upload . '</h5></div>';
								...
								echo form_open_multipart('simpanan/add_sukarela');
								...
								<div class="modal-body">
									...
									<div class="input-group input-group-outline mb-3">
										<input type="date" name="tgl_transaksi" value="<?php echo date('Y-m-d') ?>" class="form-control" placeholder="tanggal transaksi">
									</div>
									...
									<div class="input-group input-group-outline mb-3">
										<select name="no_anggota" class="form-control">
											...
											<?php foreach ($anggota as $key => $anggotas) { ?>
												<option value="<?= $anggotas->no_anggota ?>"><?= $anggotas->no_anggota ?></option>
											<?php } ?>
										</select>
									</div>
									...
									<div class="input-group input-group-outline mb-3">
										<input type="file" name="bukti" class="form-control" placeholder="Bukti Transaksi">
									</div>
								</div>
								<div class="modal-footer">
									<a href="<?= base_url('transaks/sukarela') ?>" class="btn btn-secondary" data-bs-dismiss="modal">Close</a>
