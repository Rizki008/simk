			...
			<div class="card my-4">
				<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
					<div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
						...
						<a href="<?= base_url('transaksi/add') ?>" class="btn bg-gradient-success btn-sm">
							Tambah Transaksi
						</a>
					</div>
				</div>
								...
								foreach ($bulantahun as $key => $value) { ?>
									<tr>
										...
										<td class="align-middle text-center text-sm">
											<a href="<?= base_url('transaksi/detail/' . $value->bulan . '/' . $value->tahun) ?>" class="btn bg-gradient-info btn-sm">
												Detail Transaksi
											</a>
										</td>
									</tr>
