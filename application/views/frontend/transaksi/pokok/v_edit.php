		...
		<div class="col-12">
            ...
            <h5><i class="icon fa fa-exclamation-triangle"></i>', '</h5></div>');
                ...
                <h5><i class="icon fa fa-exclamation-triangle"></i>' . $error_upload . '</h5></div>';
								...
								echo form_open_multipart('simpanan/update_pokok/' . $transaksi->id_transaksi);
								...
								<div class="modal-footer">
									<a href="<?= base_url('simpanan/pokok') ?>" class="btn btn-secondary" data-bs-dismiss="modal">Close</a>
